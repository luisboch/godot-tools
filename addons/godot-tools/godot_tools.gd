...
func _enter_tree():
	...
	add_custom_type("Evade2D", "Node2D", preload("src/evade_2d.gd"), preload("icons/flee.png"))
	...
	add_custom_type("WeightGroup2D", "Node2D", preload("src/weight_steering.gd"), preload("icons/group.png"))

func _exit_tree():
    remove_custom_type("Follow2D")
    remove_custom_type("Flee2D")
    remove_custom_type("Evade2D")
    remove_custom_type("Arrive2D")
    remove_custom_type("Pursuit2D")
    remove_custom_type("LookAt2D")
    remove_custom_type("WeightGroup2D")